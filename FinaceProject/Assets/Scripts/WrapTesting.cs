...
public class WrapTesting : MonoBehaviour
{
    ...
    public void SetWrap()
    {
        //wrapObject.GetComponent<MeshFilter>().mesh = GenerateWrap(bottomVerts, topVerts);

        //topVerts = top.GetComponent<AngleTesting>().vertexList;
        //bottomVerts = bottom.GetComponent<AngleTesting>().vertexList;

        heightDiff = top.transform.position - bottom.transform.position;

        topVerts = top.GetComponent<RotatedAngleSlice>().vertexList;
        bottomVerts = bottom.GetComponent<RotatedAngleSlice>().vertexList;

        Debug.Log("Top Verts Count " + topVerts.Count);
        Debug.Log("Bottom Verts Count " + bottomVerts.Count);
